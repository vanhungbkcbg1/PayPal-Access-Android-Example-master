...
public class AccessHelperConnect {
	...
	private static final String	URL_REDIRECT		= "https://www.google.com/?gws_rd=ssl";
...
//				.append(PARAM_RESPONSE_TYPE).append(VALUE_RESPONSE_TYPE).append("&")
...
//		return authUrlBuilder.toString();
		...
		String name="https://www.sandbox.paypal.com/cgi-bin/webscr?business="+"vanhungbkcbg1@gmail.com"+"&cmd=_xclick&currency_code=EUR&amount="+"20"+"&item_name=Ticket";
		//String name="http://vnexpress.net/";
		//return "https://www.sandbox.paypal.com/webapps/auth/protocol/openidconnect/v1/authorize";
		return "https://www.sandbox.paypal.com/webapps/auth/protocol/openidconnect/v1/authorize?client_id=AeflyJWfjwYMpbiyhkwrTzrNprp0_zUq0JBeqld7MPzQQ0SjG60QCykdaTWEFjPzq8pPlyxeCHVUa9Bl&response_type=code&scope=openid%20profile%20email%20address%20https://uri.paypal.com/services/paypalattributes&redirect_uri="+name;
	}
